...
MainController.$inject = ["$scope", "DataService", "GraphService"];

function MainController($scope, DataService, GraphService) {
  ...
  function getData() {
    DataService.get().then(function(data) {
      ...
      showGraph(
        $scope,
        GraphService.getNodes(data.nodes),
        GraphService.getConnections(data.edges)
      );
    });
  }
}

function showGraph(scope, nodes, edges) {
